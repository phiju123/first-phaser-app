module Game {
    export class ExtremeWalkingSimulator {
        ...
        preload() {
            ...
            //Spritesheets
            this.game.load.atlasXML("HERO_WALKING", "Graphics/Hero_Walking.png",
        ...
        create() {
            this.game.state.add("TitleScreenState",
                GameFromScratch.TitleScreenState, true);
            this.game.state.add("GamePlayState",
                GameFromScratch.GamePlayState, false);
